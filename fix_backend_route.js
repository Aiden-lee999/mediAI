...
const cleanedContent = `import express from 'express';
...
--- [JSON 뼈대] ---
{
  ...
  "blocks": [
    ...
    console.error("Express OpenAI Route Error:", error);
...
fs.writeFileSync('backend/src/routes/chatRoutes.ts', cleanedContent, 'utf8');
console.log('Fixed chatRoutes.ts!');
