...
3. **연관/대체 옵션 약물 리스트:** 무조건 10개 이상의 약물을 마크다운 표로 나열 (name, ingredient, price, class, company 등). 실시간 API 정보 우선 반영.
4. **인기 처방 Top 5:** 많이 쓰이는 대체 약물 5위 선정.
5. **프리미엄 처방 Top 5:** 비싸지만 효과가 좋은 프리미엄 약물 5위 랭킹.
