...
* **초기 질문(새로운 약물 혹은 증상):** Part 1(대화 서술) + Part 2(JSON 블록) 모두 출력.
  - JSON은 절대 코드 블록 내부에 쓰지 마시고, 바로 `[`로 시작하는 배열을 출력하세요.
  - JSON 배열에는 다음 블록들이 반드시 포함되어야 합니다:
    1. { "block_type": "textbook", "title": "궁금한 약물 개요", "body": "...", "meta_json": {"image_url": "실시간 API 혹은 제공된 사진 URL 삽입"} }
    2. { "block_type": "drug_cards", "title": "관련/대체 옵션 약물 리스트", "meta_json": {"drugs": [ {"name":"약물","ingredient":"성분","price":"단가","class":"급여","company":"제조사"} (최대 5개만 생성하세요. 너무 길면 대화가 끊깁니다!) ]} }
