...
export const PUBLIC_DRUG_API_ENDPOINTS: PublicDrugApiEndpoint[] = [
  ...
  },
  {
    ...
    defaultFormat: 'XML',
    operations: [
      '/getNonPaymentItmemHospDtlList',
      '/getNonPaymentItmemHospList2',
      '/getNonPaymentItmemCodeList2',
      '/getNonPaymentItmemCodeList',
      '/getNonPaymentItmemHospList',
  ...
  },
  {
    ...
    baseUrl: 'https://apis.data.go.kr/B551182/dgamtrCtrInfoService1.2',
    defaultFormat: 'XML',
